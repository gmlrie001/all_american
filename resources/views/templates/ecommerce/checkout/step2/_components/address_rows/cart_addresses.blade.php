<div class="col-12 cart-addresses">
    <div class="row">
        <div class="col-12 p-0 user-address-select">
            ...
            <span>Billing Address the same as my shipping address <i class="fa fa-check-circle active"
        ...
        <div class="col-12 user-addresses shipping-addresses">
            <div class="row">
                ...
                <div class="col-12 p-0 address-info" data-addressid="{{$user_address->id}}">
                    <h1 class="col-12">
                        <a class="delete-address float-left confirm-delete"
                            href="/address/delete/{{$user_address->id}}"><i class="fa fa-trash"></i></a>
        ...
        <div class="col-12 p-0 user-addresses billing-addresses billing-hide">
            ...
            <div class="col-12 p-0 address-info" data-addressid="{{$user_address->id}}">
                <h1>
                    <a class="delete-address float-left confirm-delete" href="/address/delete/{{$user_address->id}}"><i
