...
@section('content')
  ...
  <tr>
    <td style="font-size: 15px;line-height: 25px;color: #1f1f1f;padding-bottom: 15px;">
      We know you have been patiently waiting and would like to tell you that the following item is now back in stock:
    </td>
  </tr>
      ...
      <table width="100%;">
        <tr>
          ...
          <tr>
            ...
            <td align="center" valign="middle" style="border: 1px solid #1f1f1f;padding: 20px;color: #1f1f1f;">R {{(number_format($product->price, 2, ".", ","))}}</td>
          </tr>
      </table>
    </td>
  </tr>
